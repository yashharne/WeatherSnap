...
const errorContent = document.querySelector("[about-data-content]");
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `
        ...
        module.aqiText[aqi].message
                    ...
                    <div class="card card-sm highlight-card two" id="sun">
                        <div class="card-list" >
                            <div class="card-item">
                                <span class="m-icon">clear_day</span>
                                <p class="sunlabel">Sunrise</p>
